...
import edu.hm.carconfigurator.client.CarConfigurator;
import edu.hm.carconfigurator.client.Service;
import edu.hm.carconfigurator.client.ServiceAsync;
...
public class Log extends Composite {
 ...
 private Button btnEinloggen;
  ...
  public Log() { 
    ...
    Button passwortvergessen = new Button("Passwort vergessen");  
 ...
 error.setSize("160", "40");
  ...
  private void goToRegist() {
    ...
    System.out.println("OOOOOOOOOOOOOOOOOOOOOOUUUUUUUUUUUUUUUUUUUUUUUUPPPPPPPPPPPPA");
      CarConfigurator.get().setRegister();
